...
⚠️ 우선주 코드 주의: `daily_prices` 의 비-6자리-숫자 종목코드 10종
   ...
   ⚠️ 「경계 이후 데이터가 없다」 ≠ 「수집할 수 없다」 — 원본 `strategy_analysis.daily_candles`
      에는 2024-03-04~2026-02-10 구간이 남아 있다(실측 2026-08-16: kis `daily_prices` 에
      없는 (종목,날짜) 키 50,953개 / 285종목, `03473K` 포함). 결손 복구 백로그 참조.

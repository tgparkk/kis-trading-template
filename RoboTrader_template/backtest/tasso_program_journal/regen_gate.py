...
MANUAL_DOCS = [
    ...
    #    🔒 2026-09-16 — `FREEZE_S5_2026-09-16.md` 는 그 문서의 동결 선언이며 **만드는 «순간» 등재**한다
    #      (`FREEZE_RANKING_2026-08-31.md`·`FREEZE_WRC_2026-09-02.md`·`FREEZE_SECTOR_2026-09-03.md` 와 같은 G-1 전례
    #       · `PREREG_POST8.md` §12 (나) 1번). 🔴 등재와 파일 생성이 **같은 커밋**이라 G-1 이 한 번도 「없는 파일」을 보지 않는다.
    "FREEZE_S5_2026-09-16.md",
    ...
    # 🔴 2026-09-16 — post8 사전등록. 사람이 쓴 문서라 `MANUAL_DOCS` 자리다.
    #    🔴 **등재는 동결 커밋 «앞»이고 «별도 커밋»이다**(`PREREG_POST8.md` §0-2 0번 = §13-1 4단계)

...
| + OFS 폴백분 (연결재무제표 없는 회사) — **실측 17.45%** (2026 1Q: OFS 437 / CFS 2,068 · 무자료 51종목은 CFS·OFS 2회) | **+488** |
| **보고서 1종 실효 범위** | **≈ 3,044** (2026 1Q 백필 실측 **3,034** 호출 · 2015~ 상한 계획은 5,112 유지) |
| 2026년치 = 1Q + 반기 (2종) | **≈ 6,100** (상한 10,224) |
| 전체 소급 2015~ = 4종 × 11년 | **≈ 67,000** (상한 112,000) |

✅ **OFS 폴백 비율 실측 완료(2026-09-06, Task 8 · 2026 1Q 백필 1회차)**: 대상 2,556종목 → 적재 2,505(CFS 2,068 · OFS 437) · 무자료(013·013) 51 · 미적재 0 · 호출 3,034 · 약 18분 · WARNING/ERROR 0 · 계정행 380,816. 위 표의 실측치는 1Q 한 종 기준이라 사업보고서(11011)·반기·3Q 는 창에서 재확인할 것(상한은 그대로 둔다).
...
- **창 안** → 두 조건을 **모두** 본다:
  1. **도달성** — `status ∈ {000, 013}`. **2026-09-06 사장님 결정**: 점검(800)·HTTP
     실패 등 «소프트» 실패는 그날 호출의 **1% 까지 허용**(`REACH_TOLERANCE`) · 한도초과(020)·
     IP 차단(blocked)은 **엄격**(1건이면 FAIL).

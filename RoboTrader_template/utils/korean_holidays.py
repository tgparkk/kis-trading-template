...
_LUNAR_HOLIDAYS = {
    ...
    "2026-09-25": "추석",
    "2026-09-26": "추석 다음날",
    # 2026-09-28 은 거래일이다 — 대체공휴일이 없다(2026-09-15 정정).
    #   설·추석 연휴는 «일요일» 과 겹칠 때만 대체공휴일이 생긴다(토요일은 대상 아니다).
    #   2026 추석은 9/24(목)·9/25(금)·9/26(토) — 겹치는 일요일이 없으므로 9/28(월)은 개장한다.
    #   KIS chk-holiday 캐시와 holidays 0.83 둘 다 거래일로 본다 — 폴백만 틀렸다.
    "2027-02-06": "설날 전날",
    "2027-02-07": "설날",
    "2027-02-08": "설날 다음날",
    "2027-09-14": "추석 전날",
